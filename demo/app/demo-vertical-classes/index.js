...
const holidays = [dayjs("01.01.2018", format), dayjs("06.01.2018", format), dayjs("30.03.2018", format),
  dayjs("01.04.2018", format), dayjs("02.04.2018", format), dayjs("01.05.2018", format),
  dayjs("10.05.2018", format), dayjs("20.05.2018", format), dayjs("21.05.2018", format),
  dayjs("31.05.2018", format), dayjs("15.08.2018", format), dayjs("26.10.2018", format),
  dayjs("01.11.2018", format), dayjs("08.12.2018", format), dayjs("24.12.2018", format),
  dayjs("25.12.2018", format), dayjs("26.12.2018", format), dayjs("31.12.2018", format)]

// Type definitions for react-calendar-timeline v0.27.2
// Project: https://github.com/rikkeisoft/react-calendar-timeline
// Definitions by: Rajab Shakirov <https://github.com/radziksh>
//                 Alex Maclean <https://github.com/acemac>
//                 Andrii Los <https://github.com/rip21>
//                 Jon Caruana <https://github.com/joncar>
//                 Rikkeisoft <https://github.com/rikkeisoft>

import * as React from 'react';
import { Dayjs } from 'dayjs';

declare module '@rikkeisoft/react-calendar-timeline-dayjs' {
    ...
    > {
        ...
        items: CustomItem[];
        keys?: TimelineKeys;
        defaultTimeStart?: Date | Dayjs;
        defaultTimeEnd?: Date | Dayjs;
        visibleTimeStart?: Date | Dayjs | number;
        visibleTimeEnd?: Date | Dayjs | number;
        selected?: number[];
        sidebarWidth?: number;
    ...
    export interface DateHeaderProps<Data> {
        ...
        labelFormat?: string | (([startTime, endTime]: [Dayjs, Dayjs], unit: Unit, labelWidth: number) => string);
